// Invoice Template (with downscaled logo) — same as invoice-logo.typ but
// embeds sample-logo-small.png (900x600, ~54 KB) instead of the 54 MP source.
// Demonstrates that downscaling images to display resolution slashes cold
// render time and output size. Data is loaded from invoice.json at compile time.
...
#grid(
  ...
  [
    #image("sample-logo-small.png", width: 4cm)
  ],
)
