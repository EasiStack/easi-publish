// Invoice Template (with logo) — heavier variant of invoice.typ used to
// measure the cost of embedding an image. Identical to invoice.typ except the
// header's right cell renders sample-logo.png.
...
#grid(
  ...
  [
    #image("sample-logo.png", width: 4cm)
  ],
)
